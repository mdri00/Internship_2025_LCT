...
\\
2.Ressemblance frappante entre l'effet de l'agrégation spatiale du parasitisme (ajout de pseudointerférénce via k dans un modèle à délai fixe) et l'effet de l'agrégation temporelle du parasitisme (ajout de variab dev. via n dans un modèle sans pseudointerférence)
